...
export const Button = ({ children, disabled, type }: LabelProps) => {
  return (
    <button
      className={`cursor-pointer py-3 px-7 bg-thunder-300 border-2 border-thunder-800 rounded-xl text-xl text-thunder-950
      ...
      dark:border-thunder-300 dark:bg-thunder-800 dark:text-thunder-200
