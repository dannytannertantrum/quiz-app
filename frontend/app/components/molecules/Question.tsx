          ...
          <li key={answer.id} className='block w-auto mb-4 max-w-2xl mx-auto'>
            <button
              ...
              dark:shadow-outer-space-950 enabled:active:scale-[0.98] ${
                ...
                `shadow-inner enabled:text-outer-space-950 enabled:bg-outer-space-200 enabled:shadow-outer-space-500
                dark:enabled:text-outer-space-100 dark:enabled:bg-outer-space-900 dark:enabled:shadow-outer-space-1000
                `
              }`}
